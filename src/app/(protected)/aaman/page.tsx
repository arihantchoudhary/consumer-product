...
export default function AamanPage() {
  ...
  // This is Aaman's page
  const pageName = "Aaman";
  ...
  const startConversation = async () => {
    try {
      // Aaman's agent ID
      const agentId = "agent_6301k2rzxtr7f04ba7z12786rrwr";
  ...
  return (
    <AccessGuard requiredPage="aaman">
      <AnimatedBackground />
